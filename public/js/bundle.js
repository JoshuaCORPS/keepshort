...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"../../node_modules/shortid/lib/random/random-from-seed.js":[function(require,module,exports) {
'use strict';
...
},{"./lib/index":"../../node_modules/shortid/lib/index.js"}],"short.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteUrl = exports.shortenUrl = void 0;
...
var shortenUrl = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(full) {
    var short, createdUrl;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            short = _shortid.default.generate();
            _context.next = 5;
          ...
          case 5:
            createdUrl = _context.sent;

            if (createdUrl.data.status === 'Success') {
              window.setTimeout(function () {
                location.assign("/result/".concat(short));
              }, 500);
            }
...
var deleteUrl = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(short) {
  ...
  return function deleteUrl(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

exports.deleteUrl = deleteUrl;
},{"axios":"../../node_modules/axios/index.js","shortid":"../../node_modules/shortid/index.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var formShortUrl = document.getElementById('form-short-url');
var formDeleteUrl = document.getElementById('form-delete-url');
var copyUrl = document.getElementById('copy');

if (formShortUrl) {
  formShortUrl.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              full = full.startsWith('http') ? full : "http://".concat(full);
              ...
              _context.next = 7;
              return (0, _short.shortenUrl)(full);
...
if (copyUrl) {
  ...
  copyUrl.addEventListener('mouseout', function () {
    $('#copy').attr('data-original-title', 'Copy to clipboard');
  });
}

if (formDeleteUrl) {
  formDeleteUrl.addEventListener('submit', /*#__PURE__*/function () {
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              e.preventDefault();
              short = formDeleteUrl.dataset.shorturl;
              ...
              _context2.next = 5;
              return (0, _short.deleteUrl)(short);
